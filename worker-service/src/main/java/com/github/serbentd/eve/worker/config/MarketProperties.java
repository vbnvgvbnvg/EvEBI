 ...
 * @param queueTtl       the time-to-live duration for messages in the queue
 * @param queueMaxLength the maximum number of messages allowed in the queue before dropping head
 */
